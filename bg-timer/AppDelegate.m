...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        while(true)
        {
            NSLog(@"TimeLeft2: %f",[UIApplication sharedApplication].backgroundTimeRemaining);
            sleep(1);
        }
    });
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"bg_timer" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"bg_timer.sqlite"];
